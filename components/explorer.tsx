...
export default function Explorer() {
  ...
  return <main className={`explorer ${entered ? 'is-entered' : 'is-intro'}`}>
    ...
    <footer className="map-footer"><div className="credit"><b>EVEN</b><span>×</span><span>Colectivo por la Costa</span></div><div className="map-attribution">Datos: INEGI · CONABIO <span> / </span>{entered && imageryVisible ? 'Imagen: Esri · Vantor · Earthstar' : 'Preparación: EVEN'}</div></footer>
